...
CREATE TABLE BOOK(ID BIGINT PRIMARY KEY AUTO_INCREMENT, BOOK_NAME VARCHAR(255), GENRE_ID BIGINT);
ALTER TABLE BOOK ADD FOREIGN KEY (GENRE_ID) REFERENCES GENRE(ID);

CREATE TABLE COMMENT(ID BIGINT PRIMARY KEY AUTO_INCREMENT, COMMENT_TXT VARCHAR(255), BOOK_ID BIGINT);
