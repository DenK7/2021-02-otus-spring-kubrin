package ru.otus.base.spring.security.changelog;

import com.github.cloudyrock.mongock.ChangeLog;
import com.github.cloudyrock.mongock.ChangeSet;
import com.mongodb.client.MongoDatabase;
import ru.otus.base.spring.security.domain.*;
import ru.otus.base.spring.security.repositories.*;
...
public class MongoChangelog {
    ...
    public void insertUsers(UserRepository repository) {
        ...
        repository.save(User.builder().userName("manager").password("1").role("USER").build());
